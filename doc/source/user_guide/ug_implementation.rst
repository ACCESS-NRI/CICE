...
is required. 
**ocean_hgrid_tx1m.nc** is an example of a MOM6 supergrid netcdf file for the tripole grid.
CICE derives the required grid variables to match the grid implementation 
