...
!==============================================================================
 ...
 logical function nan_check(arr)
  ...
  subroutine ice_export_access(importState, exportState, ailohi, cpl_dt, rc)
   ...
   ! To conserve pond areas, scale by ice fractions before mapping and unscale by ice fractions after mapping
   pndfn_scaled(:,:,:,:) = apeffn(:,:,:,:) * aicen(:,:,:,:)
   ! To conserve pond volumes, scale by the pond gridcell fraction before mapping, and unscale by the pond
   ! gridcell fraction after mapping
